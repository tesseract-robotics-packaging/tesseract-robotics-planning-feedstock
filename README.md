...
Once the `tesseract-robotics` channel has been enabled, `tesseract-robotics-planning` can be installed with `conda`:
...
```
conda search tesseract-robotics-planning --channel tesseract-robotics
```

or with `mamba`:

```
mamba search tesseract-robotics-planning --channel tesseract-robotics
```
...
mamba repoquery search tesseract-robotics-planning --channel tesseract-robotics

# List packages depending on `tesseract-robotics-planning`:
mamba repoquery whoneeds tesseract-robotics-planning --channel tesseract-robotics

# List dependencies of `tesseract-robotics-planning`:
mamba repoquery depends tesseract-robotics-planning --channel tesseract-robotics
```
